...
assertIncludes(releaseVersionScriptSource, "Fallback exe asset: private/build/rust/Codex-Pro-Launcher-v${targetVersion}.exe", "release version script prints the fallback exe asset path");
